...
var App = function (_Component) {
    ...
    _createClass(App, [{
        key: "changMonth",
        value: function changMonth(c) {
            if (c == "U") {
                console.log(this.state.month), this.setState({
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement(_Calendar2.default, { year: this.state.year,
                    month: this.state.month,
                    day: this.state.day,
                    changMonth: this.changMonth.bind(this) })
            );
        }
    }]);
...
var Calendar = function (_Component) {
    ...
    _createClass(Calendar, [{
        ...
        value: function getCalendar(year, month) {
            ...
            var trs = [];
            for (var i = 0; i < arrDays.length / 7; i++) {
                trs.push(_react2.default.createElement(
                    "tr",
                    { key: i },
                    arrDays.slice(i * 7, i * 7 + 7).map(function (item, index) {
                        return _react2.default.createElement(
                            "td",
                            { key: index, className: (0, _classnames2.default)({ "today": item == new Date().getDate() && month == new Date().getMonth() && year == new Date().getFullYear() }) },
                            item
                        );
                    })
                ));
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "td",
                                { colSpan: "7", className: "change" },
                                _react2.default.createElement(
                                    "a",
                                    { href: "#", className: "last", onClick: function onClick() {
                                            _this2.props.changMonth("U");
                                        } },
                                    "\u4E0A\u4E00\u6708"
                                ),
                                _react2.default.createElement(
